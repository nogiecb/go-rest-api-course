...
// GetComment - get comment by ID from database
...
// GetCommentBySlug - get all comments by slug e.g. (path - /article/{slug})
...
// PostComment - create new comment to database
...
// UpdateComent - updates a column by ID with new comment info
...
// DeleteComment - delete a comment from Database by ID
...
// GetAllComment - get all comments from Database
